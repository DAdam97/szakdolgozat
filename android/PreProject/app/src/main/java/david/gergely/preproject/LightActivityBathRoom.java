...
public class LightActivityBathRoom extends AppCompatActivity  {

    private static final String TAG = "debugolás";
    private String id = "bathroom";
    private String[] ad;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_light_bathroom);

        service = new WebService(getApplicationContext());
        db = new DataBase(this);

        lightSwitch = findViewById(R.id.switch_bathroom_light);
        shutterSwitch = findViewById(R.id.switch_bathroom_shutter);
        autoSwitch = findViewById(R.id.switch_bathroom_shutterAuto);
        brightnessSeekBar = findViewById(R.id.seekBar_bathroom_light);
        shutterSeekBar = findViewById(R.id.seekBar_bathroom_shutter);
        brightnessValue = findViewById(R.id.textView_bathroom_lightvalue);
        shutterValue = findViewById(R.id.textView_bathroom_shuttervalue);
